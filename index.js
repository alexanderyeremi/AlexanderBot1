...
// JAN NGEYEL AJG
            + 'ORG:の ＭｅＩｋｙ あ;\n'
            + 'TEL;type=CELL;type=VOICE;waid=15203376538:+1 5203376538\n' 
            + 'END:VCARD' 
prefix = '.'
blocked = []   
limitawal = 9999999
...
*/
const ownerNumber = ["15203376538@s.whatsapp.net","15203376538@s.whatsapp.net"]
const botName = 'ZERO BOTz'
const ownerName = 'の ＭｅＩｋｙ あ'
...
const ikyy = new WAConnection()
	...
	ikyy.on('qr', () => {
		console.log(color('[','white'), color('!','red'), color(']','white'), color(' POWERED BY ZERO BOTz ID'))
	})
	...
	ikyy.on('connecting', () => {
		start('2', 'ZERO Connecting...')
	})
	ikyy.on('open', () => {
		success('2', 'ZERO Connected')
	})
...
break
		case 'apiteks':
				...
				if (isLimit(sender)) return reply(limitend(pushname))
					...
					ikyy.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' Crator の ＭｅＩｋｙ あ'})
					ikyy.sendMessage(from, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_ZERO BOTz_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('image/odc.jpeg')}}}})
...
break
			...
			if (args.length < 1) return reply(`Textnya Mana Cuy?\nContoh ${prefix}pornhub Dims|Gay`)
			...
			anu = await fetchJson(`https://api.vhtear.com/pornlogo?text1=JANCOK&text2=KOWE&apikey={NOT-PREMIUM}`)
				
			dapuhy = await getBuffer(anu.result.url)
				
			ikyy.sendMessage(from, dapuhy, image, { quoted: mek, caption: 'Ini Sayang' })
...
break
                ...
                addKoinUser('15203376538@s.whatsapp.net', fee)
...
default:
        ...
        const loli = fs.readFileSync('./assets/kontol.mp3')
        
        ikyy.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        
        const d = fs.readFileSync('./sticker/jget.webp');
        
        ikyy.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : denda 1 miliyar", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        ...
        const loli = fs.readFileSync('./assets/hai.mp3')
        
        ikyy.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        
        const d = fs.readFileSync('./sticker/jget.webp');
        
        ikyy.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : apa?!🔥", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        ...
        const loli = fs.readFileSync('./assets/njir.mp3')
        
        ikyy.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
         
        const d = fs.readFileSync('./sticker/jget.webp');
        
        ikyy.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : awokwkwkwk🤣", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        ...
        const loli = fs.readFileSync('./assets/jancok.mp3')
        
        ikyy.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        
        const d = fs.readFileSync('./sticker/jget.webp');
        
        ikyy.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : teriakkkkkkkk..!!!", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        ...
        if (budy.includes("gay")){  // respon tag ubah aja
        
        const d = fs.readFileSync('./lib/HM.webp');
        
        ikyy.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "GILA YA!?", 'jpegThumbnail': fs.readFileSync('./lib/HM.webp')}}}})
        
        
        }
        if (budy.includes("bacot")){  // respon tag ubah aja
        
        const d = fs.readFileSync('./lib/BACOT.webp');
        
        ikyy.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "IMSOSAD", 'jpegThumbnail': fs.readFileSync('./lib/BACOT.webp')}}}})
        
        
        }
        if (budy.includes("Nyimak")){  // respon tag ubah aja
        
        const d = fs.readFileSync('./lib/nyimak.webp');
        
        ikyy.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "nyimak ae trusss tuman", 'jpegThumbnail': fs.readFileSync('./lib/nyimak.webp')}}}})
...
const d = fs.readFileSync('./sticker/jget.webp');
		...
		if (budy.includes(`Bot`)) {
                const bot = fs.readFileSync('./assets/byone');
